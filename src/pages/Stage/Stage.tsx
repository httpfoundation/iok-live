import { AppBar, Grid, Tab, Tabs, Typography, Zoom, CircularProgress, TextField, Alert, FormControlLabel, Checkbox, Button, InputLabel, Select, MenuItem, FormControl } from "@mui/material"
...
import { useStage, useStore } from "../../Store"
...
const Questions = (props: {schedule?: DatoTalk[], stageId?: number}) => {
	...
	return <Box sx={{p: 2}}>
		<TextField fullWidth label="Név" color="secondary" sx={{mb: 0}} value={!anonymus ? "Gipsz Jakab" : "≪ Névtelen ≫"} disabled />
...
const StagePage = () => {
	...
	return (
		<>
			<PageHeaderTitle title={stage?.name ? `"${stage?.name}" szekció` : ""} />
